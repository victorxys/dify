...
export NEXT_PUBLIC_API_PREFIX=${NEXT_PUBLIC_API_PREFIX:-${CONSOLE_API_URL}/console/api}
export NEXT_PUBLIC_PUBLIC_API_PREFIX=${NEXT_PUBLIC_PUBLIC_API_PREFIX:-${APP_API_URL}/api}
...
export NEXT_PUBLIC_CUSTOM_CHAT_DIFY_API_KEY=${NEXT_PUBLIC_CUSTOM_CHAT_DIFY_API_KEY}
